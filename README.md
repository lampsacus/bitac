Website with content in Spanish built with HTML and minimum CSS and JS.
...
Verkkosivusto, jonka sisältö on espanjaksi ja joka on rakennettu HTML:llä ja vähintään CSS:llä ja JS:llä.
